    ...
    $action = $_GET['action'];
              ...
              $result = $db->insert("category", array(
                ...
                "create_at" => $date->date("Y-m-d", false, false)
                    ...
                    if($result){
                      ...
                      ?>
                      <script>
                      window.location.replace("index.php?page=cat_news&action=list&id=0");
                      </script>
                  <?php
                    }else
                    {
        ...
        if($action == "new")
        {
         ...
         ?>
            ...
            <hr>
              <form method="POST" action="index.php?page=cat_news&action=insert" enctype="multipart/form-data">
        ...
        if($action == "list")
        {
          ...
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              $results = $db->select("category","type = 'news_id'");
              $i = 1;
              ...
              <tr>
                ...
                <div class="btn-group">
                    <button onclick="location.href = 'index.php?page=cat_news_delete&id=<?php echo $row['id'];  ?>'"  type="button" class="btn btn-default btn-danger"><i class="fa fa-fw fa-remove" ></i></button>
                    <button onclick="location.href = 'index.php?page=cat_news_edit&id=<?php echo $row['id'];  ?>'" type="button" class="btn btn-default btn-success" ><i class="fa fa-edit"></i></button>
                    <!--Start-Modal-Edit-->
