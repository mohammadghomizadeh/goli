...
<!--                                                    <img src="_Content/Images/user2-160x160.jpg" class="img-circle" alt="User Image">-->
<!--                                                </div>-->
<!--                                                <h4>-->
<!--                                                    علیرضا-->
...
<!--                                            <a href="#">-->
<!--                                                <div class="pull-right">-->
<!--                                                    <img src="_Content/Images/user3-128x128.jpg" class="img-circle" alt="User Image">-->
<!--                                                </div>-->
<!--                                                <h4>-->
<!--                                                    نگین-->
...
<!--                                            <a href="#">-->
<!--                                                <div class="pull-right">-->
<!--                                                    <img src="_Content/Images/user4-128x128.jpg" class="img-circle" alt="User Image">-->
<!--                                                </div>-->
<!--                                                <h4>-->
<!--                                                    نسترن-->
...
<!--                                </li>-->
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="_Content/Images/avatar.png" class="user-image" alt="User Image">
                                <span class="hidden-xs">آقای گلشنی</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="_Content/Images/avatar.png" class="img-circle" alt="User Image">
